...
class AccommodationBase(BaseModel):
    ...
    booking_url: Optional[str] = Field(None, max_length=2000, description="Booking URL")
    ...
    description: Optional[str] = Field(None, max_length=10000, description="Description")
    ...
    review: Optional[str] = Field(None, max_length=10000, description="Personal review")
