...
import { Car, Footprints, Bike, Train, Plane, Ship, Bus, AlertTriangle } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-xl border border-gray-200 p-3 min-w-[200px] max-w-[280px]">
        ...
        <div className="space-y-1.5">
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm text-gray-700 truncate" title={fromName}>
                {fromName || 'Origin'}
              </p>
              <p className="text-sm text-gray-700 truncate mt-2" title={toName}>
                {toName || 'Destination'}
              </p>
            </div>
          </div>
        ...
        {/* Fallback warning */}
        {segment.is_fallback && (
          <div className="flex items-center gap-1.5 mt-2 pt-2 border-t border-gray-100 text-red-600">
