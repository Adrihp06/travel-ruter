...
const PenIcon = forwardRef(
  ({ size = 24, color = "currentColor", strokeWidth = 2, className = "" }, ref) => {
    ...
    const start = useCallback(async () => {
      await animate(".pen-group", { x: [0, 1, -1, 1, -1, 0], y: [0, -2, -4, -6, -8, -10], rotate: [0, -6, -4, -6, -4, 0] }, { duration: 0.8, ease: "easeInOut" });
    ...
    return (
      <motion.svg ref={scope} width={size} height={size} viewBox="0 0 32 32" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="square" strokeMiterlimit="10" className={className} style={{ overflow: "visible" }} onHoverStart={start} onHoverEnd={stop}>
