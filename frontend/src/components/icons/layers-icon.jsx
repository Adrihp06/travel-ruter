...
const LayersIcon = forwardRef(
  ({ size = 24, color = "currentColor", strokeWidth = 2, className = "" }, ref) => {
    ...
    return (
      <motion.svg ref={scope} onHoverStart={start} onHoverEnd={stop} width={size} height={size} viewBox="0 0 120 120" fill="none" strokeWidth={strokeWidth} xmlns="http://www.w3.org/2000/svg" className={className} style={{ overflow: "visible" }}>
